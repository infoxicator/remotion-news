import { P as ProviderError, aA as getHomeDir, aB as IniSectionType, aC as CONFIG_PREFIX_SEPARATOR, aD as slurpFile, aE as getConfigFilepath, aF as parseIni, g as getProfileName, C as CredentialsProviderError, s as setCredentialFeature } from "./server-build-DHo3NJYJ.js";
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
  const { SSOOIDCClient } = await import("./index-C-8Es3L0.js");
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
  const { CreateTokenCommand } = await import("./index-C-8Es3L0.js");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso-DN1u84IO.js");
